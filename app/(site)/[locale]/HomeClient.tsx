...
export default function HomeClient({
  ...
  // El contenido y los cursos llegan ya resueltos desde el servidor en el
  // idioma correcto — sin fetch tras hidratar, sin parpadeo de español en /en.
  const content = initialContent
  const dbCourses: Record<string, CourseInfo> = Object.fromEntries(
    initialCourses.map((c) => [c.slug, c])
  )
