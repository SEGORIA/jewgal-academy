...
const CERTS = [
  ...
  },
  {
    ...
    program: "Instructor Joogal · Adultos",
    slug: "joogal-adultos",
    entity: "Método Joogal · Certificación Oficial",
    accent: "#6BBF8E",
    grad: "linear-gradient(135deg,#0a1e15,#0e3824)",
    icon: "✦",
    duration: "3 meses",
    type: "Certificación Oficial",
    desc: "Habilitación oficial para dictar clases, talleres y retiros del Método Joogal para adultos. Reconocida dentro de la comunidad internacional de instructores Joogal.",
  ...
  },
  {
    ...
    slug: "joogalkids",
    entity: "Método Joogal · Certificación Infantil",
    accent: "#7B9FD8",
