...
const COUNTRIES = [
  {
    ...
    desc: "En Buenos Aires nació el método Joogal y comenzaron los primeros procesos de Life Coaching. Formó las primeras comunidades de bienestar y sentó las bases de su filosofía integrativa que hoy llega a todo el mundo.",
    accent: "#A58D66",
    stat: "20+",
  ...
  },
  {
    ...
    desc: "Desde Bogotá y Medellín formó a cientos de instructores Joogal y Life Coaches certificados. Colombia se convirtió en el corazón de su red latinoamericana de bienestar y transformación.",
    accent: "#6BBF8E",
    stat: "200+",
