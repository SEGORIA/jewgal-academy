...
const WHATSAPP_MESSAGE =
  "Hola Devora, me gustaría solicitar una consulta. ¿Podríamos agendar una sesión exploratoria?"
...
export default function WhatsAppFab() {
  ...
  return (
    <a
      ...
      aria-label="Solicitar una consulta por WhatsApp"
      className="wa-fab"
    >
      ...
      <span className="wa-fab-label">Consulta gratuita</span>
    </a>
  )
}
